(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-grease-scroll', ['exports', '@angular/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-grease-scroll'] = {}, global.ng.core));
}(this, (function (exports, i0) { 'use strict';

    var GreaseScrollService = /** @class */ (function () {
        function GreaseScrollService() {
         ...
         */
        GreaseScrollService.prototype.scrollTo = function (element, options) {
            var _this = this;
         ...
         */
        GreaseScrollService.prototype._getScrollLocation = function () {
            if (this._container) {
         ...
         */
        GreaseScrollService.prototype._getEasingPattern = function (type, time) {
            switch (type) {
                case 'easeInQuad':
         ...
         */
        GreaseScrollService.prototype._getEndLocation = function (element) {
         ...
         */
        GreaseScrollService.prototype._animateScroll = function () {
            var _this = this;
        ...
        ;
        return GreaseScrollService;
    }());
    GreaseScrollService.ɵprov = i0.ɵɵdefineInjectable({ factory: function GreaseScrollService_Factory() { return new GreaseScrollService(); }, token: GreaseScrollService, providedIn: "root" });
    ...
    var ScrollDirective = /** @class */ (function () {
        function ScrollDirective(_elementRef, _greaseScrollService) {
        ...
        ScrollDirective.prototype.scroll = function () {
            ...
            if (typeof this.scrollIf === 'undefined' || this.scrollIf === true) {
                setTimeout(function () {
                    _this._greaseScrollService.scrollTo(_this._elementRef.nativeElement, _this.options);
                }, 0);
            }
        };
    ...
    var ScrollToDirective = /** @class */ (function () {
        function ScrollToDirective(_greaseScrollService) {
            this._greaseScrollService = _greaseScrollService;
            this.options = {};
        }
    ...
    var GreaseScrollModule = /** @class */ (function () {
        function GreaseScrollModule() {
        }
        return GreaseScrollModule;
    }());
    ...
    exports.GreaseScrollModule = GreaseScrollModule;
    exports.GreaseScrollService = GreaseScrollService;
...
//# sourceMappingURL=ngx-grease-scroll.umd.js.map
